...
namespace Owasp.Esapi
{
	...
	internal class ObjectBuilder
	{
		...
		public static T Build<T>(string typeName)
			where T : class
		{
			if (string.IsNullOrEmpty(typeName)) throw new ArgumentException("Invalid argument", "typeName");
			...
			where T : class
		{
			...
			var instance = initParams != null && initParams.Length > 0
		...
		/// <param name="properties">Properties to set</param>
		static void SetProperties(object instance, IDictionary<string, object> properties)
		{
			...
			foreach (var propertyName in properties.Keys)
			{
				...
				if (propertyInfo == null) throw new ArgumentOutOfRangeException(propertyName);
