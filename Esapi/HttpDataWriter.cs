...
namespace Owasp.Esapi
{
	...
	internal class HttpDataWriter
	{
		...
		{
			if (_insideSection) _output.Write(") ");
		}
		...
		{
			_output.Write("{0}\"{1}\"=\"{2}\"", _hasValues ? ", " : "", name, value);
			_hasValues = true;
		}
		...
		{
			var obfuscatedValue = value;
			if (obfuscatedValues != null && obfuscatedValues.Contains(name)) obfuscatedValue = "********";
