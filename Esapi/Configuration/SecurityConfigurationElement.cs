...
namespace Owasp.Esapi.Configuration
{
	...
	public class SecurityConfigurationElement : ConfigurationElement
	{
		...
		{
			get => (AlgorithmsConfigurationElement) base[AlgorithmsPropertyName];
			set => base[AlgorithmsPropertyName] = value;
		}
		...
		{
			get => (EncryptionConfigurationElement) base[EncryptionPropertyName];
		...
		{
			get => (ApplicationConfigurationElement) base[ApplicationPropertyName];
			set => base[ApplicationPropertyName] = value;
		}
	...
	public class AlgorithmsConfigurationElement : ConfigurationElement
	{
		...
		{
			get => (string) base[EncryptionPropertyName];
			set => base[EncryptionPropertyName] = value;
		}
		...
		public string Hash
		{
			get => (string) base[HashPropertyName];
			set => base[HashPropertyName] = value;
		}
		...
		{
			get => (string) base[RandomPropertyName];
			set => base[RandomPropertyName] = value;
		}
		...
		{
			get => (string) base[DigitalSignaturePropertyName];
			set => base[DigitalSignaturePropertyName] = value;
		}
	...
	public class EncryptionConfigurationElement : ConfigurationElement
	{
		...
		{
			get => (string) base[MasterPasswordPropertyName];
			set => base[MasterPasswordPropertyName] = value;
		}
		...
		{
			get => (string) base[MasterSaltPropertyName];
			set => base[MasterSaltPropertyName] = value;
		}
	...
	public class ApplicationConfigurationElement : ConfigurationElement
	{
		...
		{
			get => (string) base[UploadValidExtensionsPropertyName];
			set => base[UploadValidExtensionsPropertyName] = value;
		}
		...
		/// </summary>
		[ConfigurationProperty(UploadMaxSizePropertyName, IsRequired = false, IsKey = false,
			IsDefaultCollection = false, DefaultValue = "50000")]
		public int UploadMaxSize
		{
			get => (int) base[UploadMaxSizePropertyName];
			set => base[UploadMaxSizePropertyName] = value;
		}
		...
		{
			get => (string) base[CharacterEncodingPropertyName];
			set => base[CharacterEncodingPropertyName] = value;
		}
		...
		{
			get => (string) base[ResponseContentTypePropertyName];
			set => base[ResponseContentTypePropertyName] = value;
		}
		...
		{
			get => (string) base[LogLevelPropertyName];
			set => base[LogLevelPropertyName] = value;
		}
		...
		{
			get => (int) base[MaxRedirectLocationPropertyName];
			set => base[MaxRedirectLocationPropertyName] = value;
		}
		...
		{
			get => (int) base[MaxFileNameLengthPropertyName];
			set => base[MaxFileNameLengthPropertyName] = value;
		}
		...
		{
			get => (bool) base[LogEncodingRequiredPropertyName];
			set => base[LogEncodingRequiredPropertyName] = value;
		}
