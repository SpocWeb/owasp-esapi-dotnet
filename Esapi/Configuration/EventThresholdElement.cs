...
namespace Owasp.Esapi.Configuration
{
	...
	public class ThresholdElement : ConfigurationElement
	{
		...
		public int Count
		{
			get => (int) base[CountPropertyName];
			set => base[CountPropertyName] = value;
		}
		...
		public int Interval
		{
			get => (int) base[IntervalPropertyName];
		...
		{
			get => (string) base[ActionsPropertyName];
			set => base[ActionsPropertyName] = value;
		}
	...
	public class EventThresholdCollection : ConfigurationElementCollection
	{
		...
		public ThresholdElement this[int index] => (ThresholdElement) BaseGet(index);
