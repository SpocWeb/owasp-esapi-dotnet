...
namespace Owasp.Esapi.Configuration
{
	...
	public class EsapiConfig : ConfigurationSection
	{
		...
		{
			get => (AccessControllerElement) base[AccessControllerPropertyName];
			set => base[AccessControllerPropertyName] = value;
		}
		...
		{
			get => (EncoderElement) base[EncoderPropertyName];
			set => base[EncoderPropertyName] = value;
		}
		...
		{
			get => (EncryptorElement) base[EncryptorPropertyName];
			set => base[EncryptorPropertyName] = value;
		}
		...
		{
			get => (IntrusionDetectorElement) base[IntrusionDetectorPropertyName];
			set => base[IntrusionDetectorPropertyName] = value;
		}
		...
		{
			get => (RandomizerElement) base[RandomizerPropertyName];
			set => base[RandomizerPropertyName] = value;
		}
		...
		{
			get => (ValidatorElement) base[ValidatorPropertyName];
			set => base[ValidatorPropertyName] = value;
		}
		...
		/// </summary>
		[ConfigurationProperty(HttpUtilitiesPropertyName, IsRequired = false, IsKey = false,
			IsDefaultCollection = false)]
		public HttpUtilitiesElement HttpUtilities
		{
			get => (HttpUtilitiesElement) base[HttpUtilitiesPropertyName];
			set => base[HttpUtilitiesPropertyName] = value;
		}
		...
		{
			get => (SecurityConfigurationElement) base[SecurityConfigurationPropertyName];
			set => base[SecurityConfigurationPropertyName] = value;
		}
				...
				if (_instance == null)
					lock (_instanceLock)
					{
						if (_instance == null)
						{
							...
							if (_instance == null) _instance = new EsapiConfig();
						}
					}
				return _instance;
			}
		...
		public string Xmlns => (string) base[XmlnsPropertyName];
	...
	public class AddinAssemblyElement : ConfigurationElement
	{
		...
		public string Types
		{
			get => (string) base[TypesPropertyName];
			set => base[TypesPropertyName] = value;
		}
	...
	public class AddinAssemblyCollection : ConfigurationElementCollection
	{
		...
		public AddinAssemblyElement this[int index] => (AddinAssemblyElement) BaseGet(index);
