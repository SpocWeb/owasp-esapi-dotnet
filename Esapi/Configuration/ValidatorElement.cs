...
namespace Owasp.Esapi.Configuration
{
	...
	public class ValidatorElement : ConfigurationElement
	{
		...
		{
			get => (ValidationRuleCollection) base[RulesPropertyName];
			set => base[RulesPropertyName] = value;
		}
	...
	public class ValidationRuleCollection : ConfigurationElementCollection
	{
		...
		public ValidationRuleElement this[int index] => (ValidationRuleElement) BaseGet(index);
		...
		{
			get => (AddinAssemblyCollection) base[AssembliesPropertyName];
			set => base[AssembliesPropertyName] = value;
		}
