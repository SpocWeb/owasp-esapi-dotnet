...
namespace Owasp.Esapi
{
	...
	{
		static IAccessController _accessController;
		static readonly object _accessControllerLock = new object();

		static IEncoder _encoder;
		static readonly object _encoderLock = new object();

		static IEncryptor _encryptor;
		static readonly object _encryptorLock = new object();

		static IHttpUtilities _httpUtilities;
		static readonly object _httpUtilitiesLock = new object();

		static IIntrusionDetector _intrusionDetector;
		static readonly object _instrusionDetectorLock = new object();

		static IRandomizer _randomizer;
		static readonly object _randomizerLock = new object();

		static ISecurityConfiguration _securityConfiguration;
		static readonly object _securityConfigurationLock = new object();

		static IValidator _validator;
		static readonly object _validatorLock = new object();
		...
		/// </summary>
		public static ILogger Logger => GetLogger("Owasp.Esapi");
