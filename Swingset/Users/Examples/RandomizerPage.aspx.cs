...
namespace Owasp.Esapi.Swingset.Users.Examples
{
	public partial class RandomizerPage : SwingsetPage
	{
		...
		protected void btnGenerate_Click(object sender, EventArgs e)
		{
			...
			txtInteger.Text = Esapi.Randomizer.GetRandomInteger(int.MinValue, int.MaxValue).ToString();
			txtDouble.Text = Esapi.Randomizer.GetRandomDouble(0, 1).ToString();
			txtString.Text = Esapi.Randomizer.GetRandomString(16, CharSetValues.Alphanumerics);
